...
const Detail = () => {
    ...
    function handleWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=${data.points.whatsapp}&text=Tenho interesse sobre coleta de resíduos`);
    }
    ...
    if(!data.points) { // aqui seria melhor uma tela de loading.
        return null;
    }
